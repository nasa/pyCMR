...
def read_variable_nc_nolim(filename, fp, timeFieldName, latFieldName, lonFieldName):
    fp.close()
...
if __name__ == "__main__":
    filename = sys.argv[1]
    args = sys.argv[2:]
    r = read_variable_nc_nolim(filename, open(filename), *args)
