...
class metaDataTool:
    ...
    def processIphexHiwrapeData(self, rootDir):
        ...
        static_data["DataSetId"] = "NRT AMSR2 L2B GLOBAL SWATH GSFC PROFILING ALGORITHM 2010: SURFACE PRECIPITATION, WIND SPEED OVER OCEAN, WATER VAPOR OVER OCEAN AND CLOUD LIQUID WATER OVER OCEAN V0"
        static_data["inv"] = "GPM_INV"
        static_data["browse"] = "N"

        dd=print_metadata(rootDir, patternsToParsers, static_data)
        return dd
    ...
    def fromJsonToXML(self, data, dataSetId):
    ...
    def getMetaData(self, rootDir, dataSetId):
        data=self.processIphexHiwrapeData(rootDir)
        commaSeperatedFile=self.ComaSeperatedDataToListJson(data=data)
        return self.fromJsonToXML(commaSeperatedFile,dataSetId)


if __name__=="__main__":
    meta=metaDataTool()
    print meta.getMetaData("/home/marouane/Documents/IPHEX",dataSetId="NRT AMSR2 L2B GLOBAL SWATH GSFC PROFILING ALGORITHM 2010: SURFACE PRECIPITATION, WIND SPEED OVER OCEAN, WATER VAPOR OVER OCEAN AND CLOUD LIQUID WATER OVER OCEAN V0")
    #print(ComaSeperatedToListJson(pathToFile="/home/marouane/Desktop/cmr-master/cmr-master/examples/data_example"))
